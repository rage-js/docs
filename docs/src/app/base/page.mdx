...
![GitHub Issues or Pull Requests](https://img.shields.io/github/issues/Maghish/RAGE?style=flat)
![GitHub deployments](https://img.shields.io/github/deployments/rage-js/docs/github-pages?style=flat&label=Deployment)
![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/rage-js/docs/pages%2Fpages-build-deployment?branch=docs&style=flat)
![GitHub Repo stars](https://img.shields.io/github/stars/rage-js/docs?style=flat)
![Static Badge](https://img.shields.io/badge/Maghish%20-%20?style=flat&label=Owner&color=A020F0)
...
- [`tool`](https://github.com/rage-js/tools) 🛠️ - Package for performing CRUD operations on the localized JSON files, without disturbing the RAGE main loop
...
<CodeBlock className="json" height="150px">
{`{
    ...
